#############################################################################
# Makefile for building: Sinfo
# Generated by qmake (2.01a) (Qt 4.6.2) on: ?? 4? 25 12:11:12 2010
# Project:  Sinfo.pro
# Template: app
# Command: /usr/lib/qt4/bin/qmake -spec /usr/lib/qt4/mkspecs/linux-g++ -unix -o Makefile Sinfo.pro
#############################################################################
...
Makefile: Sinfo.pro  /usr/lib/qt4/mkspecs/linux-g++/qmake.conf /usr/lib/qt4/mkspecs/common/g++.conf \
		/usr/lib/qt4/mkspecs/common/unix.conf \
		/usr/lib/qt4/mkspecs/common/linux.conf \
		/usr/lib/qt4/mkspecs/qconfig.pri \
		/usr/lib/qt4/mkspecs/features/qt_functions.prf \
	...
	$(QMAKE) -spec /usr/lib/qt4/mkspecs/linux-g++ -unix -o Makefile Sinfo.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/Sinfo1.0.0 || $(MKDIR) .tmp/Sinfo1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Sinfo1.0.0/ && $(COPY_FILE) --parents mainwindow.h treeview.h thread.h .tmp/Sinfo1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp treeview.cpp thread.cpp .tmp/Sinfo1.0.0/ && (cd `dirname .tmp/Sinfo1.0.0` && $(TAR) Sinfo1.0.0.tar Sinfo1.0.0 && $(COMPRESS) Sinfo1.0.0.tar) && $(MOVE) `dirname .tmp/Sinfo1.0.0`/Sinfo1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Sinfo1.0.0
...
treeview.o: treeview.cpp treeview.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o treeview.o treeview.cpp
